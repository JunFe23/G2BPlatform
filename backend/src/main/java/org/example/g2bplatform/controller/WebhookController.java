...
public class WebhookController {
    ...
    public ResponseEntity<String> deployProject() {
        try {
            ...
            pull.directory(new File("/Users/junfe/Desktop/G2B/G2BPlatform/backend")); // ✅ 여기를 실제 경로로!
            pull.inheritIO().start().waitFor();

            // 2. gradle build
            ProcessBuilder build = new ProcessBuilder("./gradlew", "bootJar");
            build.directory(new File("/Users/junfe/Desktop/G2B/G2BPlatform/backend"));
            ...
            // 4. 새 jar 실행
            Runtime.getRuntime().exec("nohup java -jar /Users/junfe/Desktop/G2B/G2BPlatform/backend/build/libs/g2bplatform-0.0.1-SNAPSHOT.jar &");
