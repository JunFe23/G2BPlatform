<template>
  <LegacySidebarLayout>
    <h1 class="construction">관련업계 전체시장 DB - 공사</h1>
...
const fetchData = async () => {
  ...
  // TODO: 나중에 이 부분은 axios.get('/api/data', { params: { category: 'constructions', ...filters } })로 교체해야 함
  setTimeout(() => {
...
const toggleSave = (item) => {
  // TODO: 나중에 이 부분은 axios.post('/api/update-checked', { category: 'constructions', id: item.id, checked: !item.checked })로 교체해야 함
