...
const fetchData = async () => {
  ...
  // TODO: 나중에 이 부분은 axios.get('/api/data', { params: { category: 'goods', ...filters } })로 교체해야 함
  setTimeout(() => {
...
const toggleSave = (item) => {
  // TODO: 나중에 이 부분은 axios.post('/api/update-checked', { category: 'goods', id: item.id, checked: !item.checked })로 교체해야 함
